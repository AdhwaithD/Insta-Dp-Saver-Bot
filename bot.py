...
START_MSG = '''*🌹ഹായ്🌹
🇮🇳ഞാൻ ഒരു insta-Dp-Saver-Bot ആണ്.➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️➖️
🇮🇳ഇനി എന്തെങ്കിലും കൂടുതലായി അറിയണമെങ്കിൽ CLICK👉 /Help
...
def start(update, context):
    ...
    update.message.reply_text(
        ...
        parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton("⛓️ Updates ⛓️", url="https://t.me/AD_BOTZ")]]))

def help_msg(update, context):
    update.message.reply_text("താഴെ എഴുതിയേക്കുന്നെ നല്ലോണം വായിച്ചു നോക്ക്👍⚡️ഇൻസ്റ്റഗ്രാം യൂസർ നെയിം ഇട്ടാൽ വിവരങ്ങൾ അറിയാം എന്തായാലും ഇവിടെവരെ വന്നതല്ലേ ഞങ്ങളുടെ സപ്പോർട്ട് ഗ്രൂപ്പിൽ ജോയിൻ ചെയ്യാവോ🥺 @AD_BOTZ")
